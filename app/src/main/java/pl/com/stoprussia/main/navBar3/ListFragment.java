package pl.com.stoprussia.main.navBar3;
...
public class ListFragment extends WebViewFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        webView = (WebView) rootView.findViewById(R.id.idWebViewList);
...
//                websiteUrl = "https://stoprussia.com.pl/31aouqtmuaa7ktdxmc9uxcuwbx9/pl/list-111";
                mapOfInsideUrls.get(UrlType.DOMAIN_TO_CURRENT_WEBVIEW).add(new EnhancedUrl.Builder("https://stoprussia.com.pl/31aouqtmuaa7ktdxmc9uxcuwbx9/pl/list-111")
                        .build());
//            } else {
                websiteUrl = "https://stoprussia.com.pl/31aouqtmuaa7ktdxmc9uxcuwbx9/list-111";

                mapOfInsideUrls.get(UrlType.DOMAIN_TO_CURRENT_WEBVIEW).add(new EnhancedUrl.Builder("https://stoprussia.com.pl/31aouqtmuaa7ktdxmc9uxcuwbx9/list-111")
                        .build());
//            }

            mapOfInsideUrls.get(UrlType.DOMAIN_TO_OUTSIDE_APP).add(new EnhancedUrl.Builder("wikipedia.org")
            .build());
